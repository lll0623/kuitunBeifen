...
<div class="index-wrapper">
	<div id="container" class="Register">
				<div class="mint-msgbox-header">
					<div class="mint-msgbox-title" style="font-size: 0.5rem">注册</div>
				</div>
				<div class="mint-msgbox-content">
                    ...
                    <div class="height50">
                        ...
                        <div class="textFormat">
                            <input type="text" class="width100" placeholder="请输入姓名" v-model="username">
                        </div>
                    </div>
				</div>
				<mt-button size="large" :disabled="btnDisabled" @click="saveMemo">注册</mt-button>
	</div>
</div>
</template>
<script type="es6">
...
import { isNull,getCookie,setCookie } from '../util'
