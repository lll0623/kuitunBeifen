...
<div class="index-wrapper">
	<div id="container" class="FeedBack">
		<div class="RadioGroup">
			<el-radio v-model="radio" label="3">投诉</el-radio>
			<el-radio v-model="radio" label="4">建议</el-radio>
			<el-radio v-model="radio" label="5">表扬</el-radio>
 			<el-radio v-model="radio" label="6">咨询</el-radio>
		</div>

		<div class="PStructSelect">
			<el-select v-model="value8" filterable placeholder="请选择房产">
			    <el-option
		...
		<div class="TextareaImg">
			<el-input type="textarea" @blur.prevent="changeLiuYan()" max="500" min="10" v-model="textarea" placeholder="输入投诉建议内容，你可以输入10-500个字。"></el-input>
			<ul class="listImg">
...
import { queryPubRoomRelaInfoList,createLinkBill,
	getAccessToken,
	getWxConf,
	saveFileByServerId,
